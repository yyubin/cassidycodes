...
export const projects: Project[] = [
  {
    ...
    relatedArticles: [
      { title: 'Annotation과 Reflection, 메타 프로그래밍 시작기', slug: 'sprout1' },
      { title: 'DI/IoC 컨테이너의 태동', slug: 'sprout2' },
      { title: 'DispatcherServlet의 본질', slug: 'sprout3' },
      { title: 'ArgumentResolver를 직접 구현하며 배운 것들', slug: 'sprout4' },
      { title: 'AOP 만들기 (1) — 프록시와 인터셉션', slug: 'sprout5' },
      { title: 'AOP 만들기 (2) — 어드바이스/포인트컷을 구현하며', slug: 'sprout6' },
      { title: '커스텀 서버의 첫 성능 실험', slug: 'sprout7' },
      { title: 'DI/IoC 컨테이너 아키텍처 재설계 (1)', slug: 'sprout8' },
      { title: 'DI/IoC 컨테이너 아키텍처 재설계 (2)', slug: 'sprout9' },
      { title: '커스텀 Non-Blocking I/O 서버 아키텍처 전체 해부', slug: 'sprout10' },
      { title: 'async-profiler로 서버의 병목을 추적하다', slug: 'sprout11' },
      { title: 'JMC + JITWatch로 본 JIT 컴파일의 세계', slug: 'sprout12' },
      { title: '성능 개선 리팩토링 — JIT 친화적 서버로 만들기', slug: 'sprout13' },
    ],
    diagrams: [
      {
  ...
  },
  {
    ...
    title: 'ACCORD',
    slug: 'accord',
    tldr: '실시간 화상 회의와 협업 도구를 결합한 플랫폼 (Miro + Discord 컨셉). 팀 리더로서 전체 시스템 아키텍처를 설계하고, Go와 WebRTC를 활용한 실시간 통신 서버를 구축하여 98%의 연결 성공률을 달성했습니다.',
    overview: '실시간 화상 회의와 협업 캔버스를 결합한 통합 협업 플랫폼입니다. 4인 팀의 팀 리더로서 프론트엔드, 백엔드, 실시간 서버의 전체 아키텍처를 설계하고 프로젝트 일정을 관리했습니다. Go 언어와 WebRTC를 활용하여 안정적인 실시간 화상/음성 통신 기능을 구현했습니다.',
    heroStats: [
      { label: '연결 성공률', value: '98%' },
      { label: '팀 역할', value: '팀 리더' },
      { label: '팀 규모', value: '5인' },
      { label: '아키텍처', value: 'MSA' },
    ],
    achievements: [
      '5인 팀 리더로서 전체 시스템 아키텍처(FE/BE/실시간 서버) 설계 및 일정 관리',
      'Go + WebRTC 기반 실시간 화상/음성 통신 서버 구축',
      '안정적인 WebRTC 연결로 성공률 98% 달성',
      'Spring Boot 기반 백엔드 API 서버 개발',
      'React 기반 실시간 협업 캔버스 UI 구현',
      'MongoDB, Redis, RabbitMQ를 활용한 데이터 및 메시징 아키텍처 설계',
      'AWS 기반 인프라 구축 및 자동 배포 파이프라인 구축',
      '시스템 모니터링 대시보드 구축으로 개발 생산성 향상',
    ],
    techStack: [
      'Spring Boot',
      'Go',
